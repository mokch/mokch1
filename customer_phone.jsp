...
<body>
        <%
            ...
            String input_name = request.getParameter("input_phone");
            String sql2 = "SELECT * FROM repairshop.customer WHERE customer_phone LIKE '%"+input_name+"%'";
        %>
     ...
     <section id="two" class="wrapper style2 special">
        ...
        <table border="1", width="30">
            ...
            %><tr><%
                ...
                %><td> <%=rs2.getString("customer_car")%></td><%
                    %><td> <%=rs2.getString("customer_visitingcount")%></td><%
                %><td> <%=rs2.getString("customer_phone")%></td><%
                %><td> <a href="customer_employee.jsp?customer_name=<%=rs2.getString("customer_name")%>">직원 찾기</a></td><%
                 %><td> <a href="customer_repair.jsp?customer_name=<%=rs2.getString("customer_name")%>">정비 찾기</a></td><%
                %></tr><%
                    }
                %>    
        </div>
