     ...
     <section id="two" class="wrapper style2 special">
        ...
        <table border="1", width="30">
            ...
            <%
                while (rs3.next()) {
            %><tr><%
                 %><td> <a href="customer_repair.jsp?customer_name=<%=rs3.getString("customer_name")%>"><%=rs3.getString("customer_name")%></a></td><%
                 %><td> <a href="customer_repair.jsp?customer_name=<%=rs3.getString("customer_name")%>"><%=rs3.getString("customer_phone")%></a></td><%
                %></tr><%
                    }
                %>    
        </div>
