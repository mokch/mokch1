...
<body>
    <section id="two" class="wrapper style2 special">
				<div class="inner narrow">
					...
					<form class="grid-form" method="post" action="repair_name_bridge.jsp">
						...
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
                                    ...
                                    <form class="grid-form" method="post" action="repair_employee_bridge.jsp">
                                            <div class="form-control">
							<label for="message">employee name</label>
						...
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
                                    ...
                                    <form class="grid-form" method="post" action="repair_repair.jsp">
                                            <div class="form-control">
							<label for="message">정비id</label>
                                                        <input name="repair_id" id="name" type="text">
						</div>
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
						</ul>
