...
<body>
        <%
            ...
            String sql3 = "SELECT * FROM repairshop.employee";
        %>
     ...
     <section id="two" class="wrapper style2 special">
        ...
        <table border="1", width="30">
            <tr>
                <td>employee id</td>
                <td>employee skilledlevel</td>
                <td>employee_name</td>        
                <td>employee phone</td>
                <td>emplpyee serviceyear</td>
            ...
            %><tr><%
                ...
                %><td> <%=rs3.getString("employee_skilledlevel")%></td><%
                %><td> <%=rs3.getString("employee_name")%></td><%
                %><td> <%=rs3.getString("employee_phone")%></td><%
                %><td> <%=rs3.getString("employee_serviceyear")%></td><%
