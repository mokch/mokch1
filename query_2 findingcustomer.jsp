...
<body>
    <section id="two" class="wrapper style2 special">
				<div class="inner narrow">
					...
					<form class="grid-form" method="post" action="customer_name.jsp">
						...
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
                                    ...
                                    <form class="grid-form" method="post" action="customer_phone.jsp">
                                            <div class="form-control">
							<label for="message">Phone</label>
                                                        <input name="input_phone" id="phone" type="text">
						</div>
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
						</ul>
