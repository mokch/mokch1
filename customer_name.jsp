...
<body>
        <%
            ...
            String sql3 = "SELECT * FROM repairshop.customer WHERE customer_name LIKE '%"+input_name+"%'";
        %>
     ...
     <section id="two" class="wrapper style2 special">
        ...
        <table border="1", width="30">
            ...
            %><tr><%
                ...
                %><td> <%=rs3.getString("customer_car")%></td><%
                    %><td> <%=rs3.getString("customer_visitingcount")%></td><%
                %><td> <%=rs3.getString("customer_phone")%></td><%
                 %><td> <a href="customer_employee.jsp?customer_name=<%=rs3.getString("customer_name")%>">직원 찾기</a></td><%
                 %><td> <a href="customer_repair.jsp?customer_name=<%=rs3.getString("customer_name")%>">정비 찾기</a></td><%
                %></tr><%
                    }
                %>    
        </div>
