...
<body>
        <%
            ...
            String input_name1 = request.getParameter("repair_id");
            String sql4 = "SELECT * FROM repairshop.repair WHERE repair.repair_id ='"+input_name1+"'";
        %>
     ...
     <section id="two" class="wrapper style2 special">
				...
				<div class="inner">
                                    <header>
						<h2><%out.println("정비id "+input_name1);%>의 정비기록</h2>
					</header>
          <table>
            <table border="1", width="830">
                ...
                %><tr><%
                    ...
                    %><td> <%=rs2.getString("repair_startingtime")%></td><%
                         ...
                         %><td> <a href="cost_1.jsp?repair_id=<%=rs2.getString("repair_id")%>">계산</a></td><%
                             %><td> <a href="cost.jsp?repair_id=<%=rs2.getString("repair_id")%>">계산</a></td><%
                    %></tr><%
                        }
                    %>
            </table> 
