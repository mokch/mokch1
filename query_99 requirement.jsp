...
<body>
    <section id="two" class="wrapper style2 special">
				<div class="inner narrow">
					...
					<form class="grid-form" method="post" action="requirement.jsp">
						<div class="form-control">
							<label for="message">정비 ID 입력</label>
						...
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
                                    ...
                                    <form class="grid-form" method="post" action="requirement_auto.jsp">
						<div class="form-control">
							<label for="message">부품 이름</label>
                                                        <input name="input_name3" id="name" type="text">
						</div>
						<ul class="actions">
							<li><input value="검색" type="submit"></li>
						</ul>
