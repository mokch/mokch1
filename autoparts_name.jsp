...
<body>
        <%
            ...
            String sql3 = "SELECT * FROM repairshop.autoparts WHERE autoparts_name LIKE '%"+input_name+"%'";
        %>
     ...
     <section id="two" class="wrapper style2 special">
        ...
        <table border="1", width="30">
            ...
            %><tr><%
                ...
                %><td> <a href="predict.jsp?autoparts_name=<%=rs3.getString("autoparts_name")%>">수요계산</a></td><% 
                    }
                %>    
        </div>
     </sectoin>
