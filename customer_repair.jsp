...
<body>
        <%
            ...
            String input_name1 = request.getParameter("customer_name");
            String sql4 = "SELECT * FROM repairshop.repair WHERE customer_id IN(SELECT customer_id FROM repairshop.customer WHERE customer_name = '"+input_name1+"')";
        %>
     ...
     <section id="two" class="wrapper style2 special">
				...
				<div class="inner">
                                    <header>
						<h2><%out.println(input_name1+"님의 정비기록");%></h2>
					</header>
          <table>
            <table border="1", width="830">
                ...
                %><tr><%
                    ...
                    %><td> <%=rs2.getString("repair_startingtime")%></td><%
                         %><td> <a href="autoparts_name2.jsp?repair_id=<%=rs2.getString("repair_id")%>">부품찾기</a></td><%
                    %><td> <a href="cost_1.jsp?repair_id=<%=rs2.getString("repair_id")%>">계산</td><%
                    %><td> <a href="cost.jsp?repair_id=<%=rs2.getString("repair_id")%>">계산<%=rs2.getString("repair_cost")%></td><%
                    %></tr><%
                        }
                    %>
            </table> 
