...
<body>
        <%
            ...
            String sql3 = "SELECT * FROM repairshop.repair WHERE repair.employee_id IN(SELECT employee.empoyee_id FROM repairshop.employee WHERE employee_name LIKE '%"+input_name+"%')";
        %>
          ...
          <table>
            <table border="1", width="830">
                ...
                %><tr><%
                    ...
                    %><td> <%=rs3.getString("repair_leadtime")%></td><%
                    %><td> <%=rs3.getString("repair_cost")%></td><%
                 %><td> <a href="customer_employee.jsp?employee_id=<%=rs3.getString("employee_id")%>">직원 찾기</a></td><%
                 %><td> <a href="customer_repair.jsp?repair_id=<%=rs3.getString("repair_id")%>">부품 찾기</a></td><%
                    %></tr><%
                        }
                    %>
            </table> 
